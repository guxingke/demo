...
import com.gxk.demo.v1.CharSequenceJavaFileObject;
import com.gxk.demo.v1.JdkDynamicCompileClassLoader;
import com.gxk.demo.v1.JdkDynamicCompileJavaFileManager;
...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    final String cp = com.gxk.demo.v1.Main.class.getClassLoader().getResource("").getPath();
